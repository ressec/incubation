 ...
 * reflect errors in program's logic and cannot be reasonably recovered from at
 * run time. Unchecked exceptions are subclasses of {@link RuntimeException},
 * and are usually implemented using {@link InvalidArgumentException},
 * {@link NullPointerException}, or {@link IllegalStateException} a method is
 * not obliged to establish a policy for the unchecked exceptions thrown by its
...
public abstract class AbstractUncheckedException extends RuntimeException
{
	...
	/**
	 * Creates a new unchecked exception based on an enumerated value and given
	 * parameters.
	 * <p>
	...
	/**
	 * Creates a new unchecked exception based on a message and a parent
	 * exception.
	 * <p>
	 * @param message Message of the exception.
	 * @param exception Parent exception.
