 ...
 * ---------------------------------------------------------------------------
 */
package org.heliosphere.drake.base.test.resource.bundle;
...
/**
 * A test case for the {@link BundleBase} class using the
...
public final class ResourceBundleTest
{
	 ...
	 */
	private static final String DUMMY_ENGLISH = "A test message from component: drake-base";

	/**
	 * Dummy message in french.
	 */
	private static final String DUMMY_FRENCH = "Un message de test du composant: drake-base";

	/**
	 * Dummy message in german.
	 */
	private static final String DUMMY_GERMAN = "Ein Test Nachricht von der Komponente: drake-base";

	/**
	 * Dummy message in spanish.
	 */
	private static final String DUMMY_SPANISH = "Un mensaje de prueba a partir del componente: drake-base";

	/**
	 * Dummy message in italian.
	 */
	private static final String DUMMY_ITALIAN = "Un messaggio di prova dal componente: drake-base";
	...
	public final void registerBundleByEnumClassInEnglish()
	{
		...
		Assert.assertTrue(
				ResourceBundleManager.getLocale().getLanguage() == english.getLanguage());
	}
	...
	public final void registerBundleByEnumClassInFrench()
	{
		...
		Assert.assertTrue(
				ResourceBundleManager.getLocale().getLanguage() == french.getLanguage());
	}
	...
	public final void registerBundleByEnumClassInGerman()
	{
		...
		Assert.assertTrue(
				ResourceBundleManager.getLocale().getLanguage() == german.getLanguage());
	}
	...
	public final void registerBundleByEnumClassInSpanish()
	{
		...
		Assert.assertTrue(
				ResourceBundleManager.getLocale().getLanguage() == spanish.getLanguage());
	}
	...
	public final void registerBundleByEnumClassInItalian()
	{
		...
		Assert.assertTrue(
				ResourceBundleManager.getLocale().getLanguage() == italian.getLanguage());
	}
	...
	public final void retrieveDummyMessageInEnglish()
	{
		try
		{
			...
			Assert.assertTrue(
					"Not the english dummy message!",
					Collator.getInstance(english).equals(
							ResourceBundleManager.getMessage(BundleBase.TestDummy),
							DUMMY_ENGLISH));
	...
	public final void retrieveDummyMessageInFrench()
	{
		try
		{
			...
			Assert.assertTrue(
					"Not the french dummy message!",
					Collator.getInstance(french).equals(
							ResourceBundleManager.getMessage(BundleBase.TestDummy),
							DUMMY_FRENCH));
		}
		catch (final ResourceException e)
	...
	public final void retrieveDummyMessageInGerman()
	{
		try
		{
			...
			Assert.assertTrue(
					"Not the german dummy message!",
					Collator.getInstance(german).equals(
							ResourceBundleManager.getMessage(BundleBase.TestDummy),
							DUMMY_GERMAN));
		}
		catch (final ResourceException e)
	...
	public final void retrieveDummyMessageInSpanish()
	{
		try
		{
			...
			Assert.assertTrue(
					"Not the spanish dummy message!",
					Collator.getInstance(spanish).equals(
							ResourceBundleManager.getMessage(BundleBase.TestDummy),
							DUMMY_SPANISH));
		}
		catch (final ResourceException e)
	...
	public final void retrieveDummyMessageInItalian()
	{
		try
		{
			...
			Assert.assertTrue(
					"Not the italian dummy message!",
					Collator.getInstance(italian).equals(
							ResourceBundleManager.getMessage(BundleBase.TestDummy),
							DUMMY_ITALIAN));
		}
		catch (final ResourceException e)
