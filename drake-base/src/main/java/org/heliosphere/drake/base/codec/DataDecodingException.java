...
/**
 * Exception thrown when an error occurs while decoding data.
 * <hr>
 * @author <a href="mailto:christophe.resse@hotmail.com">Christophe Resse</a>
 * @version 1.0.0
 */
public class DataDecodingException extends MessageException
{
	/**
	 ...
	 */
	public DataDecodingException(final Enum<? extends IBundle> value)
	{
		super(value);
	}
	 ...
	 * message.
	 */
	public DataDecodingException(final Enum<?> key, final Object... parameters)
	{
	 ...
	 */
	public DataDecodingException(final Exception exception)
	{
		super(exception);
	}
	 ...
	 * exception.
	 */
	public DataDecodingException(final String message)
	{
		super(message);
	}
	 ...
	 * @param exception Parent {@link Exception}.
	 */
	public DataDecodingException(final String message, final Exception exception)
	{
