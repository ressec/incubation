...
/**
 * Exception thrown when an error occurs while encoding a message.
 * <hr>
...
public class MessageEncodingException extends MessageException
{
	 ...
	 */
	public MessageEncodingException(final Enum<? extends IBundle> value)
	{
		super(value);
	}
	 ...
	 * message.
	 */
	public MessageEncodingException(final Enum<?> key, final Object... parameters)
	{
	 ...
	 */
	public MessageEncodingException(final Exception exception)
	{
		super(exception);
	}
	 ...
	 * @param exception Parent {@link Exception}.
	 */
	public MessageEncodingException(final String message, final Exception exception)
	{
