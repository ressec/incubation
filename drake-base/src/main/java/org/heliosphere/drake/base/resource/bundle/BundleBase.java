...
/**
 * Enumeration of the resource bundles of the {@code drake-base} module. Each
 * enumerated value maps to a key in the resource bundle file.
 * <p>
 * <b>Note:</b><br>
 * In the {@code Drake} framework, the enumerated values are not in full
 * uppercase.
 * <hr>
...
public enum BundleBase implements IBundle
{
	/**
	 * Bundle name.
	 * <p>
	 ...
	 */
	BundleFilename("bundle.drake-base"),

	/**
	 * Root for all messages of the {@code BundleBase} component.
	 * <p>
	 * <b>Note:</b><br>
	 * Must have the name of the project artifact followed by the dot (.)
	 * character.
	 */
	BundleRoot("drake-base."),
	 ...
	 */
	private BundleBase(final String key)
	{
		this.key = key;
	}
	...
	{
		if (!key.equals(BundleBase.BundleRoot.key) && !key.equals(BundleBase.BundleFilename.key))
		{
			return BundleBase.BundleRoot.getKey() + key;
		}
