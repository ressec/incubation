...
@BundleEnumRegister
public enum BundleIcareBase implements IBundle
{
	/**
	 * Bundle name.
	 * <p>
	...
	/**
	 * A dummy message from component: icare-base.
	 */
	...
	/**
	 * The test resource bundle key that does not exists in the resource bundle
	 * file.
	 */
	...
	/**
	 * Error thrown when trying to encode/decode some data and no class catalog
	 * has been set.
	 */
	EncodingClassCatalogIsNull("encoding.classCatalogIsNull"),

	/**
	 * Error thrown when trying to encode/decode some data and the object codec
	 * is null.
	 */
	EncodingCodecObjectIsNull("encoding.codecObjectIsNull"),

	/**
	 * Error thrown when trying to encode/decode some data and the data encoding
	 * algorithm is null.
	 */
	EncodingAlgorithmIsNull("encoding.algorithmIsNull"),

	/**
	 * Error thrown when trying to encode some data and the object passed as
	 * parameter is null.
	 */
	EncodingObjectIsNull("encoding.objectIsNull"),

	/**
	 * Error thrown when trying to encode/decode some data and the buffer passed
	 * as parameter is null.
	 */
	EncodingBufferIsNull("encoding.bufferIsNull"),

	/**
	 * Message indicating that a class is already registered in the class
	 * catalog.
	 */
	EncodingClassAlreadyRegistered("encoding.classAlreadyRegistered"),

	/**
	 * Error thrown while decoding an element for which there is a mismatch on
	...
	/**
	 * Message indicating that a class does not implement the
	...
	/**
	 * Message indicating that a class to be registered is in collision with a
	 * class already registered in the class catalog.
	 */
	...
	/**
	 * Error thrown while decoding an element for which the declaring class does
	 * not implement the {@code Encodable} interface.
	 * <p>
	 * <code>
	...
	/**
	 * Error thrown while decoding a primitive element that is not recognized as
	...
	/**
	 * Element is declared as transient, and thus will be excluded from the
	 ...
	 * <p>
	 * <b>Message:</b><br>
	 * {@code Command [command.type= 0}, command.protocol.class={1}] is not part
	 * of the registered command protocol}
	 */
	 ...
	 * <dt><b>Message:</b></dt>
	 * <dd>Command converter registered [converter.name= {0},
	 * converter.fullname={1}]</dd>
	 * <dt><b>Param 0:</b></dt>
	 ...
	 * <dt><b>Message:</b></dt>
	 * <dd>Command converter unregistered [converter.name= {0},
	 * converter.fullname={1}]</dd>
	 * <dt><b>Param 0:</b></dt>
	 * <dd>Converter class name</dd>
	 * <dt><b>Param 1:</b></dt>
	 ...
	 * <p>
	 * <b>Message:</b><br>
	 * {@code Command [command.class= 0}, command.value={1}, command.regex={2},
	 * command.usage={3}] does not match its regular expression}
	 */
	 ...
	 * <p>
	 * <b>Message:</b><br>
	 * {@code Command alias [command.alias= 0}, command.name={1}] is already
	 * registered with another command}
	 */
	 ...
	 * <p>
	 * <b>Message:</b><br>
	 * {@code Command [command.category= 0}, command.type={1}] is excluded from
	 * registration}
	 */
	...
	/**
	 * Short name for honorific title: MR.
	 */
	EnumHonorificShortMister("enum.honorific.short.mister"),

	/**
	 * Long name for honorific title: MR.
	 */
	EnumHonorificLongMister("enum.honorific.long.mister"),
	...
	/**
	 * Property containing the path of the folder that contains the application
	 * log files.
	 */
	...
	/**
	 * Property defining the message encoder type to use to encode/decode
	 * messages.
	 */
	 ...
	 */
	private BundleIcareBase(@SuppressWarnings("hiding") final String key)
	{
		this.key = key;
	}
	...
	{
		if (!key.equals(BundleIcareBase.BundleRoot.key) && !key.equals(BundleIcareBase.BundleFilename.key))
		{
			return BundleIcareBase.BundleRoot.getKey() + key;
		}
