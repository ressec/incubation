...
/**
 * Enumeration of the honorific titles a {@code IPerson} can have.
 * <hr>
...
public enum HonorificType implements IIcareType
{
	/**
	 ...
	 */
	@BundleEnum(file="bundle.icare-base", path="icare-base.enum.honorific.short")
	 ...
	 */
	@BundleEnum(file="bundle.icare-base", path="icare-base.enum.honorific.long")
	 ...
	 */
	@BundleEnum(file="bundle.icare-base", path="icare-base.enum.honorific.help")
